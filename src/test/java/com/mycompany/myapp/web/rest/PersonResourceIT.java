...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().personName(DEFAULT_PERSON_NAME).age(DEFAULT_AGE);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().personName(UPDATED_PERSON_NAME).age(UPDATED_AGE);
        return person;
    }
    ...
    void putExistingPerson() throws Exception {
        ...
        updatedPerson.personName(UPDATED_PERSON_NAME).age(UPDATED_AGE);
